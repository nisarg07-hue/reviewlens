...
async def run_test():
    ...
    try:
        ...
        # -> Fill the review URL field and submit the analysis request, then check the page for an upgrade prompt or any blocked state.
        ...
        # -> Click the Analyze button to attempt another analysis and observe whether the upgrade prompt or blocking UI appears.
        # button "Analyze"
